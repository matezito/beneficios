                        ...
                        <div class="col-md-4 col-12 beneficio <?php echo beneficios_front()->get_beneficio_by_user(wp_get_current_user()->ID, get_the_ID()) ? 'bg-secondary text-white' : '' ?>" data-term="<?php echo beneficios_front()->show_terms_slug_by_post(get_the_ID()) ?>">
                            ...
                            <div class="text mt-3 mb-3">
                                ...
                                <button type="button" <?php if (get_post_meta(get_the_ID(), '_beneficio_date', true)) {
                                                            echo 'disabled';
                                                        } ?> class="solicitar btn <?php echo beneficios_front()->get_beneficio_by_user(wp_get_current_user()->ID, get_the_ID()) ? 'btn-warning' : 'btn-primary' ?>" data-id="<?php echo get_the_ID() ?>" data-user="<?php echo wp_get_current_user()->ID ?>" data-date="" id="solicitar-<?php echo get_the_ID() ?>">
